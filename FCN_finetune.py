#This is my FCN for training finetune(e.g.one annotated image) first modified at 20180510 21:10.
...
tf.flags.DEFINE_string("logs_dir", "logs20180511/", "path to logs directory")
...
tf.flags.DEFINE_string("data_dir", "image_save20180517_finetune_017", "path to dataset")
#the learning rate
...
#The mode.
tf.flags.DEFINE_string('mode', "train_finetune", "Mode train/ test/ visualize")
