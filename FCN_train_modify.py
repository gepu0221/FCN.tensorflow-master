#This is my FCN for training first modified at 20180505 15:10.
...
tf.flags.DEFINE_string("logs_dir", "logs20180510/", "path to logs directory")
...
tf.flags.DEFINE_string("data_dir", "image_save_small_size20180510", "path to dataset")
#the learning rate
